 ...
 */
final class Version20200305150003 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bills ADD CONSTRAINT FK_22775DD09395C3F3 FOREIGN KEY (customer_id) REFERENCES customer (id)');
        $this->addSql('CREATE INDEX IDX_22775DD09395C3F3 ON bills (customer_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bills DROP FOREIGN KEY FK_22775DD09395C3F3');
        $this->addSql('DROP INDEX IDX_22775DD09395C3F3 ON bills');
